...
// We import your new custom animation wrapper instead of framer-motion directly
    ...
    <div className="min-h-screen bg-white font-sans selection:bg-orange-200 overflow-x-hidden">
      ...
      <div className="relative min-h-screen flex flex-col">
        ...
        <main className="relative z-10 flex-grow flex flex-col items-center justify-center text-center px-6 pt-12 pb-24">
          <FadeIn delay={0.1} className="inline-block bg-white/10 backdrop-blur-md text-orange-400 px-4 py-1.5 rounded-full text-sm font-bold mb-6 border border-white/20 shadow-sm">
            🚀 Built for the PM Surya Ghar Scheme
          </FadeIn>
          
          <FadeIn delay={0.2}>
            <h1 className="text-5xl md:text-7xl font-extrabold text-white leading-tight mb-8 max-w-5xl">
          ...
          <FadeIn delay={0.6} className="flex flex-col sm:flex-row justify-center gap-4 w-full sm:w-auto">
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        ...
        <FadeIn delay={0.2} className="bg-gray-900 rounded-3xl overflow-hidden shadow-2xl border border-gray-200 relative aspect-video flex items-center justify-center group">
          <video 
            autoPlay 
            loop 
            muted 
      ...
      <section className="bg-white py-24">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <FadeIn delay={0.1} className="p-8 bg-gray-50 rounded-2xl border border-gray-100 text-left hover:shadow-xl transition">
            ...
            <FadeIn delay={0.3} className="p-8 bg-gray-50 rounded-2xl border border-gray-100 text-left hover:shadow-xl transition">
              <div className="text-4xl mb-6">💰</div>
            ...
            <FadeIn delay={0.5} className="p-8 bg-gray-50 rounded-2xl border border-gray-100 text-left hover:shadow-xl transition">
